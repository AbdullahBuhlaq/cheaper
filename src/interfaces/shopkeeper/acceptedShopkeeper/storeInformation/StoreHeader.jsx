        ...
        <div className="profile-info-header">
          <div className="fix">
            <motion.div
              ...
              onMouseEnter={() => setHeight(true)}
              onMouseLeave={() => setHeight(false)}
            ...
            >
              ...
              <motion.div
                ...
                style={{
                  ...
                  width: "88%",
                  background:
                    "linear-gradient(225deg, rgba(71, 204, 255, 0.3) 0%,  rgba(71, 204, 255, 0.3) 50% , rgba(255,121,0,0.3)  50%, rgba(255,121,0,0.3)  100%)",
                  overflow: "hidden",
                  position: "absolute",
                  left: "7px",
                  borderRadius: "10px",
            ...
            <div className="left-side">
              ...
              <p>
                العنوان : {props.storeInformation.information["locationText"]}
              </p>
            </div>
          </div>
          <div className="right-side">
            ...
            <span className="amount">
              المدينة : {props.storeInformation.information["city"]}
            </span>
            <p>
              أوقات الافتتاح : من{" "}
              {props.storeInformation.information["fromHour"]} إلى{" "}
              {props.storeInformation.information["toHour"]}
            </p>
          </div>
        </div>
      </>
