...
const errorMessages = {
  ...
  birthday: {
    "date.base": 'حقل "تاريخ الولادة" يجب أن يكون تاريخًا.',
    "date.format": 'حقل "تاريخ الولادة" يجب أن يكون بتنسيق تاريخ صالح.',
    "date.max": 'حقل "تاريخ الولادة" يجب أن يكون تاريخًا قبل اليوم.',
    "date.min": 'حقل "تاريخ الولادة" يجب أن يكون تاريخًا بعد "1930-01-01".',
    "any.required": 'حقل "تاريخ الولادة" مطلوب.',
  },
  size: {
