...
function RightOfferItem(props) {
  ...
  useEffect(() => {
    if (remainingTime == "") {
      ...
      setRemainingTimeWidth(
        new Date(new Date().toISOString()) - new Date(props.item.createdAt)
      );
        ...
        >
          ...
          <div className="download-area">
            <div className="download-item-icon" style={{ marginLeft: "10px" }}>
              <img
                src={
                  props.item.store.avatar
                    ? getAvater(props.item.store.avatar)
                    : storeImag
                }
                alt=""
                style={{
              ...
              172800000 ? (
                ...
                <>
                  ...
                  <div className="progress-bar">
                    <span
                      className="progress"
                      style={{ width: remainingTimeWidth / 1728000.0 + "%" }}
                    ></span>
                  </div>
                </>
              )}
