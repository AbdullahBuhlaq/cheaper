          ...
          <>
            <div className="right-area homeuser">
              ...
              {props.currentOffer.state !== false ? (
                <>
                  <div className="qr-code">
                    <span style={{ fontSize: "120px", display: "flex", flexDirection: "column", alignItems: "center" }}>
                      <TfiGift />
                      <span style={{ fontSize: "20px" }}>{props.currentOffer.state}</span>
                    </span>
                  </div>
                </>
                ...
                <>
                  <div className="qr-code">
                    <QRCode fgColor="#0086d9" bgColor="rgba(0,0,0,0)" size={512} style={{ height: "auto", maxWidth: "130px", width: "130px" }} value={props.currentOffer.QR} viewBox={`0 0 256 256`} />
