...
function PacksHeader(props) {
  const [tempFilter, setTempFilter] = useState(searchOptions.packs);
        ...
        <div className="app-content-actions">
          ...
          <div className="app-content-actions-wrapper">
            <div className="filter-button-wrapper">
              ...
              {openFilter ? <PacksFilter filter={props.filter} setFilter={props.setFilter} tempFilter={tempFilter} setTempFilter={setTempFilter} setOpenFilter={setOpenFilter} /> : null}
            </div>
          </div>
        </div>
      </>
