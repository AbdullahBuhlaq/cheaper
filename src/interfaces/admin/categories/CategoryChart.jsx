...
function CategoryChart(props) {
  ...
  useEffect(() => {
    if (categoryChart.loading && checkPermissions(props.userInformation, ["admin.category.chart", "admin.category.all"])) getCategoryChart(props.id, props.userInformation, props.setUserInformation, props.refreshStatus, props.setRefreshStatus, setCategoryChart, categoryChart, props.toast, props.name);
  }, []);
    ...
    return (
      <>
        <div className="chartContainer categories-chart-container">
          {!checkPermissions(props.userInformation, ["admin.category.chart", "admin.category.all"]) ? (
