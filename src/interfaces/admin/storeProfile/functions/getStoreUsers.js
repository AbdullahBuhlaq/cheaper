...
export default async function getStoreUsers(userInformation, setUserInformation, refreshStatus, setRefreshStatus, setUsers, users, toast, usersPage, setUsersPage, id) {
  try {
    ...
    if (data.success) {
      ...
      if (data.error == "jwt expired") {
        ...
        await getStoreUsers({ ...userInformation, ...status }, setUserInformation, refreshStatus, setRefreshStatus, setUsers, users, toast, usersPage, setUsersPage, id);
      } else {
