...
export default async function getBlocks(userInformation, setUserInformation, refreshStatus, setRefreshStatus, setBlocks, toast) {
  try {
    ...
    if (data.success) {
      ...
      if (data.error == "jwt expired") {
        ...
        await getBlocks({ ...userInformation, ...status }, setUserInformation, refreshStatus, setRefreshStatus, setBlocks, toast);
      } else {
