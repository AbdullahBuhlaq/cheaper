...
export default async function editBlock(block, currentEdit, userInformation, setUserInformation, refreshStatus, setRefreshStatus, setDuringAdd, blocks, setBlocks, toast) {
  try {
    ...
    if (data.success) {
      ...
      if (data.error == "jwt expired") {
        ...
        await editBlock(block, currentEdit, { ...userInformation, ...status }, setUserInformation, refreshStatus, setRefreshStatus, setDuringAdd, blocks, setBlocks, toast);
      } else {
