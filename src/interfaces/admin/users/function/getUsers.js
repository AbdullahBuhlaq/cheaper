...
export default async function getUsers(userInformation, setUserInformation, refreshStatus, setRefreshStatus, setUsers, users, toast, filter, usersPage, setUsersPage) {
  try {
