...
function OfferSearch(props) {
  const [tempFilter, setTempFilter] = useState({ search: "", statePaid: -1, type: -1 });
        ...
        <div className="app-content-actions">
          ...
          <div className="app-content-actions-wrapper">
            <div className="filter-button-wrapper">
              ...
              {openFilter ? <OfferFilter filter={props.filter} setFilter={props.setFilter} tempFilter={tempFilter} setTempFilter={setTempFilter} setOpenFilter={setOpenFilter} /> : null}
            </div>
          </div>
        </div>
      </>
