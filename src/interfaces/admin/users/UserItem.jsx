    ...
    return (
      <>
        <motion.div
          ...
          style={{
            backgroundColor: props.user.blocked ? "#ff00003b" : "initial",
            textDecoration: props.user.disableAt ? "line-through" : "initial",
            textDecorationColor: "red",
          }}
        >
          <div className="product-cell image">
            <img
              src={props.user.avatar ? getAvater(props.user.avatar) : userImag}
          ...
          <div className="product-cell status-cell">
            <span
              className={
                "status" + (props.user.active ? " active" : " disabled")
              }
            >
              {props.user.active ? "نشط" : "غير نشط"}
            </span>
          </div>
          <div className="product-cell option">
            ...
            <div className="dropdown">
              {checkPermissions(props.userInformation, [
                "admin.users.block.information",
                "admin.users.update",
                "admin.users.delete",
                "admin.users.block.allBlockForUser",
                "admin.users.block.deleteBlock",
                "admin.users.block.multiUnBlock",
                "admin.users.block.blockUser",
              ]) ? (
                <button
                  onClick={() => {
              ...
              <ul className={"dropdown-content" + (showOptions ? " show" : "")}>
                ...
                {props.user.disableAt ? null : checkPermissions(
