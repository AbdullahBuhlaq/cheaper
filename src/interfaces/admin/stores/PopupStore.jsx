...
function PopupStore(props) {
  ...
  const [spamPage, setSpamPage] = useState({
    page: 1,
    size: 5,
    loadMore: true,
    loadingNow: false,
          ...
          <>
            <div className="modal-left">
              <div className="modal-image-wrapper">
                <AutoSlidingImages
                  images={
                    information.storeInfo.story.length ? story : defaultStory
                  }
                />
              </div>
              <div className="modal-info-header">
                <div style={{ display: "flex" }}>
                  <img
                    src={
                      information.storeInfo["user.avatar"]
                        ? getAvater(information.storeInfo["user.avatar"])
                        : userImag
                    }
                    style={{
                      width: "109px",
                  ...
                  >
                    <h1 className="modalHeader-js">
                      {information.storeInfo["user.name"]}
                    </h1>
                ...
                <div className="right-side">
                  <div className="dropdown">
                    ...
                    <ul
                      id="myDropdown"
                      className={
                        "dropdown-content" + (openOptions ? " show" : "")
                      }
                    >
                      <li>
                        <a
              ...
              <div className="info-bar">
                <div className="info-wrapper">
                  ...
                  <span>
                    الرقم: {information.storeInfo["user.phoneNumber"]}
                  </span>
                </div>
                <div className="info-wrapper">
                  <div className="info-icon">
              ...
              >
                <Map
                  width={"100%"}
                  height={"500"}
                  lat={information.storeInfo.latitude}
                  long={information.storeInfo.longitude}
                />
              </div>
            </div>
            <div
            ...
            >
              ...
              <div className="modal-right" style={{ height: "48%" }}>
                <div className="app-main-right-header">
                  <span>
                    {(
                      Math.round(information.evaluateAverage * 100) / 100
                    ).toFixed(2)}
                  </span>
                  <a href="#">التقييمات</a>
                </div>
