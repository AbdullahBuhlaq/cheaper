          ...
          <div className="filter-menu-buttons">
            ...
            {props.tempFilter.city != -1 || props.tempFilter.category != -1 ? (
              <button
                className="filter-button reset"
                onClick={() => {
                  props.setTempFilter({ search: props.tempFilter.search, city: -1, type: false, category: -1 });
                  props.setFilter({ ...props.filter, search: props.tempFilter.search, city: -1, type: false, category: -1 });
                  props.setOpenFilter(false);
                }}
              >
                إلغاء الفلتر
