        ...
        <div className="app-content-actions">
          ...
          <div className="app-content-actions-wrapper">
            <div className="filter-button-wrapper">
              ...
              {openFilter ? <AcceptedFilter filter={props.filter} setFilter={props.setFilter} tempFilter={tempFilter} setTempFilter={setTempFilter} setOpenFilter={setOpenFilter} categories={props.categories} /> : null}
            </div>
          </div>
        </div>
      </>
