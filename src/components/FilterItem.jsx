          ...
          <div className="search-filters-container">
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "start" }}>
              <select
                ...
                style={{ marginLeft: "10px", backgroundImage: "none", width: "100%", marginTop: "5px", padding: "12px", border: "none", borderBottom: "3px solid #0298ff", color: "var(--main-font-color)", borderRadius: "6px", float: "center", backgroundColor: "var(--cards-area-bg)", boxShadow: "0px 3px 7px #3a3a3a2e !important", marginBottom: 0 }}
              >
